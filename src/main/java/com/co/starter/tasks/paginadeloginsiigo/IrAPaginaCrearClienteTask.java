...
public class IrAPaginaCrearClienteTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitUntil.the(HomePage.BOTON_CREAR_USUARIO, isVisible()).forNoMoreThan(30).seconds(),
                Click.on(HomePage.BOTON_CREAR_USUARIO)
                /*WaitUntil.the(HomePage.LINK_CLIENTES_MODAL, isVisible()).forNoMoreThan(30).seconds(),
